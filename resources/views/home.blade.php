...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/templatemo-tale-seo-agency.css') }}">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('images/services-01.jpg')}}" alt="discover SEO" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('images/services-02.jpg')}}" alt="data analysis" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('images/services-03.jpg')}}" alt="precise data" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('images/services-04.jpg')}}" alt="SEO marketing" class="templatemo-feature">
                </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-features owl-carousel">
            <div class="item">
              <img src="{{asset('images/projects-01.jpg')}}" alt="">
            ...
            <div class="item">
              <img src="{{asset('images/projects-02.jpg')}}" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{asset('images/projects-03.jpg')}}" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{asset('images/projects-04.jpg')}}" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{asset('images/projects-05.jpg')}}" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{asset('images/projects-06.jpg')}}" alt="">
              <div class="down-content">
